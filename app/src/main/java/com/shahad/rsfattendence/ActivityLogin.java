...
//            dismissWithCheck(loadingDialogId);
    ...
    private void getLocation() {
        ...
        if (ContextCompat.checkSelfPermission(ActivityLogin.this,
            ...
            // Permission is granted, get the location using the new LocationRequest.Builder
            LocationRequest locationRequest = new LocationRequest.Builder(
                    ...
                    .setMaxUpdateDelayMillis(5000)          // max delay between updates (5 seconds)
                    .build();
...
//        dismissWithCheck(loadingDialogLoc);
    ...
    private void getAccessCode() {
        ...
        String url = "https://119.148.12.94/RASolarERPWebServices/RASolarERP_SecurityAdmin.svc/" +
